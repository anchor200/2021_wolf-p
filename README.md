...
### 実験者向けの注意：<br>
<ul>
  <li>タイマーが正しく進んでいるかは、ブラウザでF12(or Fn+F12)を押すと確認できる。正しく進んでいる場合には、数が加算されているはず。</li>
  <li>おかしなことが起こったら、<strong>議論が終わってしまったあとの場合</strong>は、実験者の画面を共有して同じ画面まで来てもらう。そしてページを更新してもらう。←これ大事！！！！</li>
  <li><strong>議論が始まる前の場合</strong>は、その人に、その実験trialの最初の画面に戻ってもらう。</li>
  <li>おかしなことが起きている＝ログが進まないが、その人は操作したと言っているケース</li>
</ul>
